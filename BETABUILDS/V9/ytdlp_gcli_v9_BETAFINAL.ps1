function MainMenu {Set-Location ~\; 
    ...
    if ($youtubelink -eq "C") {
        ...
        if ($typeselection -eq "N") {
            ...
            Write-Host "Downloading Non-YouTube video..."; ./yt-dlp $youtubelink -f "bv*+ba"; DonwloadDone;
        }
        else {
            ...
            elseif ($typeselection -eq "4K") {
                ...
                $videoid = "137+140"; Write-Host $videoid;
            }
            Clear-Host; BeforeDownloadRoutine; Clear-Host;
